...
i.struct.new(new Map([["name", i.string], ["age", i.i8]]), "struct_name_age");
i.struct_name_age.assert({ name: "hjiayz", age: 90 });
i.enum.new(new Map([["none", []], ["some", [i.string]]]), "enum_option_string");
i.enum_option_string.assert("none");
i.enum_option_string.assert({ "some": "nice" });
i.enum.new(new Map([["none", []], ["some", [i.string, i.string]]]), "enum_option_string_string");
